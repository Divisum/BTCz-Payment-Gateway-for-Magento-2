...
namespace SilverStoreS\Btcz\Block;
...
class Success extends \Magento\Sales\Block\Order\Totals
{
	...
	public function getPingbackUrl($InvoiceID)
	{
		...
		return $this->_storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_WEB).'btcz/index/index';
	}
	...
	public function getIframe($incrementid, $total, $expire = 20)
	{
		...
		$this->logger->addInfo("order call - ".$RESP);
